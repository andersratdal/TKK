...
exports.handler = async (event) => {
  ...
  try {
    ...
    const amountNok = Number(process.env.SCHOOL_SIGNUP_AMOUNT_NOK || signup.amount_nok || 1500);
    ...
    return json(200, { url: session.url, session_id: session.id, amount_nok: amountNok });
  } catch (error) {
    console.error(error);
